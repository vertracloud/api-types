...
export const API_KEY_SCOPES: Record<APIApiKeyScope, APIApiKeyScopeEntry> = {
	...
	"account:write": {
		...
		routes: [
			...
			{ method: "POST", path: "/v1/users/me/resource-organization/folders" },
			{ method: "PATCH", path: "/v1/users/me/resource-organization/folders/:folder_id" },
			{ method: "DELETE", path: "/v1/users/me/resource-organization/folders/:folder_id" },
			{ method: "PUT", path: "/v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id" },
			{ method: "DELETE", path: "/v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id" },
			{ method: "PUT", path: "/v1/users/me/resource-organization/favorites/:resource_type/:resource_id" },
			{ method: "DELETE", path: "/v1/users/me/resource-organization/favorites/:resource_type/:resource_id" },
		],
	},
	"workspaces:read": {
		group: "workspaces",
	...
	"workspaces:write": {
		...
		routes: [
			...
			{ method: "POST", path: "/v1/workspaces/:id/resource-organization/folders" },
			{ method: "PATCH", path: "/v1/workspaces/:id/resource-organization/folders/:folder_id" },
			{ method: "DELETE", path: "/v1/workspaces/:id/resource-organization/folders/:folder_id" },
			{ method: "PUT", path: "/v1/workspaces/:id/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id" },
			{ method: "DELETE", path: "/v1/workspaces/:id/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id" },
			{ method: "PUT", path: "/v1/workspaces/:id/resource-organization/favorites/:resource_type/:resource_id" },
			{ method: "DELETE", path: "/v1/workspaces/:id/resource-organization/favorites/:resource_type/:resource_id" },
